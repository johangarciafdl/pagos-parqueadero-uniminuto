...
export class KioskService {
     ...
     * que un estudiante.
     */
    public static registerGuest<ThrowOnError extends boolean = true>(options: Options<kioskRegisterGuestData, ThrowOnError>) {
        return (options.client ?? client).post<kioskRegisterGuestResponses, kioskRegisterGuestErrors, ThrowOnError>({
            responseType: 'json',
     ...
     */
    public static vehicleQr<ThrowOnError extends boolean = true>(options: Options<kioskVehicleQrData, ThrowOnError>) {
        return (options.client ?? client).get<kioskVehicleQrResponses, kioskVehicleQrErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
